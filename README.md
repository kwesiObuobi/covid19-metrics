...
- [Live Demo Link](https://covid19-metrics.onrender.com)
...
```
git clone https://github.com/kwesiObuobi/covid19-metrics.git
```
...
- This capstone proeject is based on the original design idea of [Nelson Sakwa on Behance](https://www.behance.net/sakwadesignstudio).
